...
An `.nbs` song is a note block song file that is generated by [Open NBS Studio](https://opennbs.org/), a program commonly used by Minecraft musicians to compose note block songs.
